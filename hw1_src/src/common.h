...
struct request {
    uint64_t request_id;       // An unsigned 64-bit integer encoding the request ID
    struct timespec timestamp; // A timespec structure encoding the timestamp (in seconds and nanoseconds) at which the client sent the request
